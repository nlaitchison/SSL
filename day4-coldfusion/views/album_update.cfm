<div id="main_content">
    ...
    <cfoutput>
        ...
        <section>
            <form id="create_album" method="post" action="?action=updateAlbum">
                <fieldset>
                	<div class="hidden_id">
						<input type="text" name="albumId" readonly="readonly" value='#albumId#'/>
					</div>
                    <div class="form_input">
                        <label for="album_name"> Album Name </label>
                        <input type="text" name="album_name" id="album_name" value="#albumName#" />
                    ...
                    <div class="form_input">
                        ...
                        <input type="text" name="album_artist" id="album_artist" value="#albumArtist#"/>
                    </div>
                </fieldset>	
                <fieldset>
                    <div class="form_input">
                        <label for="album_image"> Album Image </label>
                        <input type="file" accept="image" name="album_image" id="album_image" value="#albumImage#"/>
                    </div>
                    <div class="form_input">
                        <label for="album_description"> Album Description </label>
                        <div class="clear_fix"></div>
                        <textarea name="album_description" id="album_description">#albumDescription#</textarea>
                    </div>
                    <div class="form_input">
                        <label for="album_release_date"> Album Release Date </label>
                        <input type="date" name="album_release_date" id="album_release_date" placeholder="MM/DD/YYYY" value="#albumReleaseDate#"/>
                    </div>
                </fieldset>
                <fieldset>
                    <div class="form_input">
                ...
                <fieldset>
                    <label> Album Format </label>
                        <div class="form_input">	
                            ...
                            <input type="text" name="twelve_stock" placeholder="Enter Amount in Stock"/>
                        ...
                        <div class="form_input">
                            ...
                            <input type="text" name="seven_stock" placeholder="Enter Amount in Stock"/>
                        ...
                        <div class="form_input">
                            ...
                            <input type="text" name="cd_stock" placeholder="Enter Amount in Stock"/>
                        ...
                        <div class="form_input">
                            ...
                            <input type="text" name="cassette_stock" placeholder="Enter Amount in Stock"/>
                ...
                <fieldset>
                    <div class="form_input">
                        ...
                        <input type="url" name="artist_site" id="artist_site" value="#albumWebsite#"/>
                    </div>
                </fieldset>	
                <fieldset>
